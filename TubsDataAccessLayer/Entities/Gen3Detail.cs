// -----------------------------------------------------------------------
// <copyright file="Gen3Details.cs" company="Secretariat of the Pacific Community">
...
namespace Spc.Ofp.Tubs.DAL.Entities
{
    ...
    /// deficiencies in MS Access VBA, necessitated collecting GEN3 details
    /// using a separate class from TripMonitorDetails.
    /// </summary>
    public class Gen3Detail : IAuditable, IEntity
    {
