...
namespace Spc.Ofp.Tubs.DAL.Entities
{
    ...
    public class PurseSeineSet
    {
        ...
        /// <summary>
        /// Set number with respect to the trip.  Should be monotonically increasing
        /// during the trip
        /// </summary>
        public virtual int? SetNumber { get; set; }

        /// <summary>
        /// Time of set start as recorded in the vessel log
        /// </summary>
        public virtual DateTime? StartOfSetFromLog { get; set; }
        /// <summary>
        /// Time the skiff leaves the boat (should be the same
        /// as start of set) as recorded by observer
        /// </summary>
        public virtual DateTime? SkiffOff { get; set; }
        /// <summary>
        /// Time at which pursing begins as recorded by the observer
        /// </summary>
        public virtual DateTime? WinchOn { get; set; }
        /// <summary>
        /// Time at which pursing ends as recorded by the observer
        /// </summary>
        public virtual DateTime? RingsUp { get; set; }
        /// <summary>
        /// Time that brailing begins as recorded by the observer
        /// </summary>
        public virtual DateTime? BeginBrailing { get; set; }
        /// <summary>
        /// Time that brailing ends as recorded by the observer
        /// </summary>
        public virtual DateTime? EndBrailing { get; set; }
        /// <summary>
        /// Time at which the set is complete (skiff on board)
        /// as recorded by the observer
        /// </summary>
        public virtual DateTime? EndOfSet { get; set; }

        /// <summary>
        /// Onboard total weight before this set (observer)
        /// </summary>
        public virtual decimal? WeightOnboardObserved { get; set; }
        /// <summary>
        /// Onboard total weight before this set (vessel log)
        /// </summary>
        public virtual decimal? WeightOnboardFromLog { get; set; }
        /// <summary>
        /// Total tonnage retained this set (observer)
        /// </summary>
        public virtual decimal? RetainedTonnageObserved { get; set; }
        /// <summary>
        /// Total tonnage retained this set (vessel log)
        /// </summary>
        ...
        /// <summary>
        /// The number of tons of catch that have just come on board
        /// as recorded by the observer
        /// </summary>
        ...
        /// <summary>
        /// The number of tons of tuna in this set as recorded by the observer
        /// </summary>
        public virtual decimal? TonsOfTunaObserved { get; set; }
        /// <summary>
        /// The sum of all brails using brail #1
        /// </summary>
        public virtual decimal? SumOfBrail1 { get; set; }
        /// <summary>
        /// The sum of all brails using brail #2
        /// </summary>
        ...
        /// <summary>
        /// The approximate percentage of skipjack in the total target catch
        /// </summary>
        public virtual int? SkipjackPercentage { get; set; }
        /// <summary>
        /// The number of tons of skipjack in the total target catch
        /// </summary>
        ...
        /// <summary>
        /// The approximate percentage of yellowfin in the total target catch
        /// </summary>
        public virtual int? YellowfinPercentage { get; set; }
        /// <summary>
        /// The number of tons of yellowfin in the total target catch
        /// </summary>
        ...
        /// <summary>
        /// The number of tons of bigeye in the total target catch
        /// </summary>
        ...
        public virtual IList<PurseSeineSetCatch> CatchList { get; set; }

        public PurseSeineSet()
        {
            CatchList = new List<PurseSeineSetCatch>();
        }

        public virtual void AddSetCatch(PurseSeineSetCatch setcatch)
        {
            setcatch.FishingSet = this;
            CatchList.Add(setcatch);
        }
    }
}
